...
const varaintBaseMap = {
  ...
  [MESSAGE_VARIANTS.USER]: 'bg-n-slate-3 dark:bg-n-slate-10 text-n-slate-12 dark:text-white border border-n-weak dark:!prose-invert',
      ...
      :class="[
        ...
        variant === MESSAGE_VARIANTS.PRIVATE
          ...
          : [MESSAGE_VARIANTS.AGENT, MESSAGE_VARIANTS.BOT, MESSAGE_VARIANTS.TEMPLATE].includes(variant) 
            ? 'text-white' 
            : 'text-n-slate-11 dark:text-white/70',
      ]"
      class="mt-2"
    />
  </div>
